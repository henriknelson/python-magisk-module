...
set_permissions() {
  ...
  ui_print "[4/6] Installing to /data/python..";
  mkdir -p /data/python;
  cp -r $MODPATH/custom/python/* /data/python/;
  chown -R root:shell /data/python;
  chmod -R 755 /data/python;
  #chown -R 0:0 $MODPATH/system/lib64;
  #chmod 755 -R $MODPATH/system/lib64;
  find /data/python -type d -exec chmod 755 {} \+;
  find /data/python -type f -exec chmod 755 {} \+;
  find /data/python -type l -exec chmod 755 {} \+;
